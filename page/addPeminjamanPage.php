...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #17337A; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    ...
    <hr>
    <form action="../process/createPeminjamansProcess.php" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" name="judulBuku" id="judulBuku">
                <option>
                    <?php
                    $query = mysqli_query($con, "SELECT judulBuku FROM buku ORDER BY id_buku");
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="tanggalPeminjaman" name="tanggalPeminjaman" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Tanggal Pengembalian</label>
            <input class="form-control" id="tanggalPengembalian" name="tanggalPengembalian" aria-describedby="emailHelp">
        </div>

        <div class="d-grid gap-2">
            <button type="submit" class="btn btn-primary" name="tambahPengembalian">Tambah Peminjaman</button>
        </div>
    </form>
</div>
