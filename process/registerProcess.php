...
if(isset($_POST['register']))
{
    ...
    "INSERT INTO users(username, password, namaPengguna, nomorIdentitas, email, jenisKelamin) VALUES
    ('$username',  '$password',  '$namaPengguna',  '$nomorIdentitas',  '$email', $jenisKelamin')")
