...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;1,500&display=swap"
        rel="stylesheet">
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://images.unsplash.com/photo-1548048026-5a1a941d93d3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80"
            ...
            <div class="carousel-item">
                <img src="https://images.unsplash.com/photo-1549675584-91f19337af3d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=872&q=80"
                    class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block bgColor">
                    <h2 class="display-4">PERPUSTAKAAN KITA</h2>
            ...
            <div class="carousel-item">
                <img src="https://images.unsplash.com/photo-1577985051167-0d49eec21977?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1489&q=80"
                    class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block bgColor">
                    <h2 class="display-4">PERPUSTAKAAN KITA</h2>
    ...
    <div class="d-flex">
        <div class="card" style="width: 18rem;">
            <img class="card-imgtop"
                src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80"
                alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card mx-4" style="width: 18rem;">
            <img class="card-imgtop"
                src="https://media.istockphoto.com/photos/can-you-keep-a-secret-picture-id1071323224?b=1&k=20&m=1071323224&s=170667a&w=0&h=Ohhkw79tBMATMYxXt8N9SDvulL9k9vplnuX2fw_OF5A="
                alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img class="card-imgtop"
                src="https://images.unsplash.com/photo-1586810165616-94c631fc2f79?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80"
                alt="Card image cap">
            <div class="card-body">
    ...
    <center>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>
                        <center> Copyright © 2021 by Pemrograman Web UAJY </center>
